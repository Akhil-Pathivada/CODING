...
with the condition that all the values in the left subtree of a node should be less than all the values in the
...
void BSTToMinHeap( struct node *root, int *arr, int *i)
{
	if(!root)
		return;
...
void BSTToMinHeapUtil(struct node *root)
{
